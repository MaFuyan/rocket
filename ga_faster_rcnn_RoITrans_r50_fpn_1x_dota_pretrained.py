...
model = dict(
    type='RoITransformer',
    # pretrained='./work_dirs/ga_faster_rcnn_RoITrans_r50_fpn_1x_dota_pretrained/pretrained_roi_transformer.pth',
    pretrained=None,
    backbone=dict(
        type='ResNet',
        depth=101,
...
data_root = '/home/hnu/Pictures/rocket/'
img_norm_cfg = dict(
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'val1024/annotations/DOTA_val1024.json',
...
log_level = 'INFO'
work_dir = './work_dirs/ga_faster_rcnn_RoITrans_r50_fpn_1x_dota_pretrained8'
load_from = './work_dirs/ga_faster_rcnn_RoITrans_r50_fpn_1x_dota_pretrained/pretrained_roi_transformer.pth'
# load_from = None
resume_from = None
workflow = [('train', 1)]
